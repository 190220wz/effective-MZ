...
LEFT JOIN gmall.ods_spu_info spu ON sku.spu_id = spu.id AND spu.ds = '20211214'
LEFT JOIN gmall.ods_base_category3 c3 ON sku.category3_id = c3.id AND c3.ds = '20211214'
LEFT JOIN gmall.ods_base_category2 c2 ON c3.category2_id = c2.id AND c2.ds = '20211214'
LEFT JOIN gmall.ods_base_category1 c1 ON c2.category1_id = c1.id AND c1.ds = '20211214'
LEFT JOIN gmall.ods_base_trademark tm ON sku.tm_id = tm.id AND tm.ds = '20211214'
LEFT JOIN (
  SELECT
    sku_id,
...
(
    ...
    TBLPROPERTIES ('orc.compress' = 'snappy');
insert overwrite table dim_coupon_full partition(dt='20250701')
SELECT
    ci.id,
    ci.coupon_name,
...
(
    ...
    TBLPROPERTIES ('orc.compress' = 'snappy');
insert overwrite table dim_activity_full partition(dt='20250701')
select
    rule.id,
    info.id,
    activity_name,
...
(
    ...
    TBLPROPERTIES ('orc.compress' = 'snappy');
insert overwrite table dim_province_full partition(dt='20250701')
select
    province.id,
    province.name,
    province.area_code,
...
(
    ...
    TBLPROPERTIES ('orc.compress' = 'snappy');
insert overwrite table dim_user_zip partition (dt = '20250701')
select id,
