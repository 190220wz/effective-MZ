...
(
    ...
    from gmall.ods_order_detail data
    where ds = '20250627'
) od
left join
(
    select
        ...
        data.user_id,
        data.province_id
    from gmall.ods_order_info data
    where ds = '20250627'
) oi
...
(
    ...
    from gmall.ods_order_detail_activity data
    where ds = '20250627'
) act
...
(
    select
        data.order_detail_id,
        data.coupon_id
    from gmall.ods_order_detail_coupon data
    where ds = '20250627'
) cou
...
(
    select
        ...
        data.payment_type,
        data.callback_time
    from gmall.ods_payment_info data
    where ds='20250627'
) pi
...
(
    ...
    from gmall.ods_order_status_log data
    where ds='20250627'
...
from gmall.ods_coupon_use data
where ds='20250627';
...
select
    ...
    data.create_time,
    '20250627'
from gmall.ods_favor_info data
where ds='20250627';
