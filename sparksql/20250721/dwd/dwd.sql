...
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table day717.dwd_trade_pay_suc_detail_inc
    partition (dt)
select cargo.id,
       order_id,
       cargo_type,
...
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table day717.dwd_trans_receive_detail_inc
    partition (dt)
select cargo.id,
       order_id,
       cargo_type,
...
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table day717.dwd_trans_dispatch_detail_inc
    partition (dt)
select cargo.id,
       order_id,
       cargo_type,
...
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table day717.dwd_trans_bound_finish_detail_inc
    partition (dt)
select cargo.id,
       order_id,
       cargo_type,
...
insert overwrite table day717.dwd_trans_sign_detail_inc
    partition (dt)
select
    cargo.id,
    order_id,
...
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table day717.dwd_trans_deliver_suc_detail_inc
    partition (dt)
select cargo.id,
       order_id,
       cargo_type,
...
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table day717.dwd_trade_order_process_inc
    partition (dt)
select cargo.id,
       order_id,
       cargo_type,
