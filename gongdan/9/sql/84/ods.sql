...
CREATE TABLE ods_page_visit_log (
    ...
    STORED AS ORC
    location '/bigdata_warehouse/day84/ods/ods_page_visit_log/';
...
CREATE TABLE ods_user_info (
   ...
   phone_prefix STRING COMMENT '手机号前3位'
    ...
    PARTITIONED BY (dt STRING)
    STORED AS ORC
    location '/bigdata_warehouse/day84/ods/ods_user_info/';
...
CREATE TABLE ods_product_info (
  ...
  create_time TIMESTAMP COMMENT '创建时间'
    ...
    PARTITIONED BY (dt STRING)
    STORED AS ORC
    LOCATION '/bigdata_warehouse/day84/ods/ods_product_info/';
...
CREATE TABLE ods_shop_page_info (
    ...
    PARTITIONED BY (dt STRING)
    STORED AS ORC
    LOCATION '/bigdata_warehouse/day84/ods/ods_shop_page_info/';
...
CREATE TABLE ods_order_info (
    ...
    PARTITIONED BY (dt STRING)
    STORED AS ORC
    LOCATION '/bigdata_warehouse/day84/ods/ods_order_info/';
...
CREATE TABLE ods_traffic_source (
    ...
    PARTITIONED BY (dt STRING)
    STORED AS ORC
    LOCATION '/bigdata_warehouse/day84/ods/ods_traffic_source/';
...
CREATE TABLE ods_marketing_activity (
    ...
    PARTITIONED BY (dt STRING)
    STORED AS ORC
    LOCATION '/bigdata_warehouse/day84/ods/ods_marketing_activity/';
...
CREATE TABLE ods_page_relationship (
   ...
   create_time TIMESTAMP COMMENT '创建时间'
    ...
    PARTITIONED BY (dt STRING)
    STORED AS ORC
    LOCATION '/bigdata_warehouse/day84/ods/ods_page_relationship/';
